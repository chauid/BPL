...
int main(int argc, char* argv[])
{
	...
	params.weight_init = WeightInitMethod::UniformDistribution;
	...
	model.addLayer(72, ActiveFunction::Sigmoid);
	model.addLayer(10, ActiveFunction::Sigmoid);
	model.addLayer(2, ActiveFunction::Sigmoid);
